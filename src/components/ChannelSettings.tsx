...
const DEFAULT_CHANNELS: ChannelConfig[] = [
  ...
  },
  {
    ...
    hint: "Публикация через полуавтоматический режим: копирование текста, скачивание картинки и открытие редактора Дзена",
    guide: {
      title: "Как публиковать в Дзен",
      steps: [
        "Включите канал «Яндекс Дзен» в настройках.",
        "При создании поста выберите канал «Яндекс Дзен».",
        "Нажмите кнопку «Подготовить пост для Дзена».",
        "Текст скопируется в буфер обмена, картинка скачается.",
        "Откроется редактор Дзена — вставьте текст и загрузите картинку.",
      ],
      note: "Полноценный API у Дзена нет, поэтому используется полуавтоматический режим.",
    },
  },
  {
    channel: "vcru",
    ...
    label: "VC.ru",
    placeholder: "не требуется",
    hint: "Публикация через полуавтоматический режим: копирование текста, скачивание картинки и открытие редактора VC.ru",
    guide: {
      title: "Как публиковать на VC.ru",
      steps: [
        "Включите канал «VC.ru» в настройках.",
        "При создании поста выберите канал «VC.ru».",
        "Нажмите кнопку «Подготовить пост для VC.ru».",
        "Текст скопируется в буфер обмена, картинка скачается.",
        "Откроется редактор VC.ru — вставьте текст и загрузите картинку.",
      ],
      note: "У VC.ru нет публичного API для авторов, поэтому используется полуавтоматический режим.",
    },
  },
];
...
function VkConnectBlock() {
  ...
  return (
    <div className="rounded-md border p-3 space-y-3 bg-muted/30">
      ...
      <p className="text-xs text-muted-foreground">
        Используется Authorization Code Flow — токен <span className="font-medium text-foreground">бессрочный</span>, переподключать не нужно.
      </p>
      <Button
        type="button"
        variant="outline"
