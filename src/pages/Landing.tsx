...
const plans = [
  {
    ...
    price: "0",
    period: "навсегда",
    features: ["5 постов в месяц", "1 соцсеть", "AI-генерация (3 запроса)", "Базовые шаблоны"],
    popular: false,
  },
  {
    name: "Базовый",
    price: "490",
    period: "/ мес",
    features: ["50 постов в месяц", "Все соцсети", "AI-генерация (50 запросов)", "Все шаблоны", "Отложенный постинг", "Контент-план"],
    popular: true,
  },
  {
    name: "Про",
    price: "1 490",
    period: "/ мес",
    features: ["Безлимитные посты", "Все соцсети", "AI без ограничений", "Все шаблоны", "Приоритетная поддержка", "Генерация изображений", "API-доступ"],
    popular: false,
  },
];
      ...
      <section id="pricing" className="py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            Годовая подписка — скидка 20%. Оплата через ЮКасса.
          </p>
        </div>
      </section>
