...
export default function Signup() {
  ...
  const handleGoogle = async () => {
    try { await signInWithGoogle(); } catch { toast.error("Ошибка входа через Google"); }
  };

  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-8">
      <SEO title="Регистрация — КроссПост" description="Создайте аккаунт КроссПост и публикуйте посты в Telegram, ВКонтакте и MAX с AI." path="/signup" />
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Зарегистрируйтесь и начните публиковать контент</CardDescription>
        </CardHeader>
